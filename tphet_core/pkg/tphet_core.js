...
* @returns {any}
*/
export function js_cone_field_on(figure, x) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.js_cone_field_on(retptr, addHeapObject(figure), addHeapObject(x));
...
* @returns {any}
*/
export function js_cone_trunk_field_on(figure, x, parts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.js_cone_trunk_field_on(retptr, addHeapObject(figure), addHeapObject(x), addHeapObject(parts));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('tphet_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
